...
class Player:
    ...
    def __init__(self, name, position, age, team, player_id):
...
class Session:
    def __init__(self, session_id, player_id, session_date:datetime, duration_minutes, sprint_count, total_distance, max_speed, touches_left, touches_right):
